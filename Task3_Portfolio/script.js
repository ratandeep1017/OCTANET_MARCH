$(document).ready(function () {
    ...
    //     animateProgressBar("python", 50);
    //     animateProgressBar("java", 50);
    // });

    // function animateProgressBar(language, percentage) {
    //     const progressBar = document.querySelector(`.bars .${language}`);
